...
```bash
git remote add encore encore://timewise-web-with-ai-vck2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/timewise-web-with-ai-vck2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/timewise-web-with-ai-vck2/settings/integrations/github)
